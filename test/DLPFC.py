...
os.chdir('/home/zhangchen/sync/humanpilot')
...
for pid in pid_list:
    ...
    nmi,ari,y_pred_last,emb,final_epoch_idx=dilate2_train5_visium(model3,model2,coord_x,coord_y,n_clusters,step_kl,step_con,step_con1,step_ce,label,img,mask,y_pred_init,200,400,tol=1e-3,update_interval=4,q_cut=q_cut,cat_tol=1e-2,mod3_ratio=mod3_ratio)
    ari_list.append(ari)
    ...
    sc.pl.spatial(adata,color='y_pred_init')
